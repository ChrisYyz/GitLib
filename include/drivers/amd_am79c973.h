...
namespace myos
{
    namespace drivers
    {
        ...
        class amd_am79c973 : public Driver, public hardwarecomu::InterruptHandler
        {
            ...
            hardwarecomu::Port16Bit MACAddress0Port;
            hardwarecomu::Port16Bit MACAddress2Port;
            hardwarecomu::Port16Bit MACAddress4Port;
            hardwarecomu::Port16Bit registerDataPort;
            hardwarecomu::Port16Bit registerAddressPort;
            hardwarecomu::Port16Bit resetPort;
            hardwarecomu::Port16Bit busControlRegisterDataPort;
        ...
        public:
            ...
            amd_am79c973(myos::hardwarecomu::PeripheralComponentInterconnectDeviceDescriptor *dev, myos::hardwarecomu::InterruptManager* interrupts);
            ~amd_am79c973();
