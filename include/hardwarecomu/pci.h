...
#ifndef __MYOS__HARDWARECOMU__PCI_H
#define __MYOS__HARDWARECOMU__PCI_H
...
namespace myos
{
    namespace hardwarecomu
    {
        ...
        public:
            ...
            void SelectDrivers(myos::drivers::DriverManager* driverManager, myos::hardwarecomu::InterruptManager* interrupts);
            myos::drivers::Driver* GetDriver(PeripheralComponentInterconnectDeviceDescriptor dev, myos::hardwarecomu::InterruptManager* interrupts);
