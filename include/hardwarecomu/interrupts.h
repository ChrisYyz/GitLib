#ifndef __MYOS__HARDWARECOMU__INTERRUPTS_H
#define __MYOS__HARDWARECOMU__INTERRUPTS_H
    ...
    namespace hardwarecomu
    {
        ...
        class InterruptManager {
            ...
            protected:
                ...
                myos::hardwarecomu::Port8BitSlow picMasterCommand;
                myos::hardwarecomu::Port8BitSlow picMasterDate;
                myos::hardwarecomu::Port8BitSlow picSlaveCommand;
                myos::hardwarecomu::Port8BitSlow picSlaveData;
        };
    }
}
